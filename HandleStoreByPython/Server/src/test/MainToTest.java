...
public class MainToTest {
    ...
    public static void main(String[] args) {
     ...
     //   String modelName = "<http://localhost:5000/Birth>";
        ...
        String hostName   = "172.17.242.251";
        String hostPort   = "5000";
        String modelName  = "http://localhost:5000/Birth"; //"http://cybersecurity/";
        String query =" SELECT ?s ?p ?o WHERE { ?s ?p ?o }";
        String username = "nosql";
        String password = "Air@Lio@2023";
        String modelToPut= null;
        //HandleStore hs = new HandleStore(hostName, storeName, hostPort, username, password);
   ...
   /**************************************get with NoSQL Connection*****************************************************/  
        ...
        try {
            resSelect = hs.get(modelName, query);
        ...
        if (resConstruct.isModel()) {System.out.println("resultSet of Construct is a model");
        ...
        if (resConstruct.isResultSet()){ System.out.println("resultSet of Construct is a resultset");
        ...
        if (resConstruct.isBoolean()){Boolean b = resConstruct.getBooleanResult();
                                   System.out.println("Construct Boolean Result :"+b);}
        if (resConstruct.isGraph() ){System.out.println("resultSet of SelectConstruct is a graph");
